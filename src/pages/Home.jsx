            ...
            <section className="py-12 md:py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-10 md:mb-16">
                        <h2 className="text-2xl sm:text-3xl font-serif font-bold text-ogene-900 mb-4">Why Choose OGENE?</h2>
                        <div className="h-1 w-16 sm:w-20 bg-ogene-500 mx-auto rounded-full"></div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {features.map((feature, idx) => (
                            ...
                            >
                                <div className="h-14 w-14 sm:h-16 sm:w-16 bg-ogene-100 text-ogene-600 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 transform rotate-3 hover:rotate-6 transition-transform">
                                    <feature.icon size={28} className="sm:w-8 sm:h-8" />
                                </div>
                                <h3 className="text-lg sm:text-xl font-bold text-ogene-900 mb-2 sm:mb-3">{feature.title}</h3>
                                <p className="text-sm sm:text-base text-ogene-500 leading-relaxed">{feature.description}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
